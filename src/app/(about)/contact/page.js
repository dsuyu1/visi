...
export const metadata = {
  title: "Contact",
  description: `Get in touch with VISI through the form on this page, or email us at ${siteMetadata.email}`,
};


export default function Contact() {
  return (
    <section className="w-full h-auto md:h-[75vh] bg-surface dark:bg-surfaceDark flex  flex-col md:flex-row items-center justify-center text-dark dark:text-light">
